...
def fill_arrival_datetimes(csv_file):
    ...
    with open('ake_updated.csv', 'w') as output_file:
         ...
         for name, group in grouped:
             ...
             for i, row in group_sorted.iterrows():
                 ...
                 # Stop has arrival datetime
                    ...
                    prev_stop_time = datetime.strptime(row['Arrival_datetime'], '%Y-%m-%d %H:%M:%S')
...
def process_files(directory):
    ...
    for csv_file in csv_files:
        print(csv_file)
        # Fill empty arrival datetimes
        fill_arrival_datetimes(csv_file)
        x = input()
