...
def get_previous_days(n, current_stop_order, current_stop_id, df, stops_dict):
    ...
    print("filtered df in get_previous_days")
    print(filtered_df)
...
if os.path.exists(joblib_path):
    ...
    joblib.dump(filtered_data, test_path)
...
file = './Checkpoints/Category_{category}_100_128/best_model.h5'.format(category=category)
...
for name, group in grouped_data:
    ...
    unique_combinations = group_sorted[['Stop_id', 'Stop_order']].drop_duplicates().values.tolist()
