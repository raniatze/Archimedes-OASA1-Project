...
def main():
    with open('ake.csv') as csv_file:
	 ...
	 # Round up or down to the closest hour	
         ...
         new_row = f"{route_id};{rtype};{stop_id};{stop_order};{minute_of_day};{day_of_month};{day_of_week};{week_of_year};{day_of_year};{is_holiday};{temperature};{precipitation};{t_pa_in_veh}"
         print(new_row)
       else:
